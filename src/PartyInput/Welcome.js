        ...
        return(
            <div className='Welcome'>
                <div className= 'welcomeBanner'>
                    ...
                    <p className="instructions">TO BEGIN: Please enter your players' information using the form below, or if your party is already in the DB, enter your DM ID below.</p>
                </div>
                <PartyInput
